...
bernoulli_distribution = init_distribution(BernoulliDistribution())
uniform_distribution = init_distribution(UniformDistribution())
binomial_distribution = init_distribution(BinomialDistribution())
poisson_distribution = init_distribution(PoissonDistribution())
geometric_distribution = init_distribution(GeometricDistribution())
negative_binomial_distribution = init_distribution(NegativeBinomialDistribution())
...
chi_squared_distribution = init_distribution(ChiSquaredDistribution())
